...
var dialog = [
	...
	"USE \"LEFT CLICK\" TO DASH THROUGH THE NEXT GUARDS. YOU WILL NOT RECEIVE DAMAGE IF YOU DO IT RIGHT AND YOU CAN RUN AWAY.",
	
	"",
	
	"NICE! NOW, HEALTH YOURSELF USING \"Q\" ON THE MEDICAL KIT",
